...
struct NKZUncompressor {
    
    static func uncompressWithArchiveData(cdir: NKZCentralDirectory, data: NSData) -> NSData? {
    ...
    static func uncompressWithFileBytes(cdir: NKZCentralDirectory, fromBytes bytes: UnsafePointer<UInt8>) -> NSData? {
    ...
    static func uncompressWithCentralDirectory(cdir: NKZCentralDirectory, fromBytes bytes: UnsafePointer<UInt8>) -> NSData? {
